...
(function( $ ) {
	...
	*/
	...
	$('#position-3-primary').click(function() {
		var notice = new PNotify({
			title: 'Message Sent!',
			text: 'Thank you for your feedback. Enjoy your day :)',
	...
	$('#position-3-warn').click(function() {
		var notice = new PNotify({
			title: 'Is it not yours!',
			text: 'Stalking not alowed here :)',
			addclass: 'notification-info stack-bottomright',
